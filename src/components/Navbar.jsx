        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12 }}>
          {user ? (
            ...
            <>
              ...
              <Link to="/register" onClick={() => setMenuOpen(false)} style={{ background: '#ef4444', color: '#fff', textDecoration: 'none', padding: '8px 16px', borderRadius: 8, fontSize: isMobile ? 13 : 14, fontWeight: 700, whiteSpace: 'nowrap' }}>
                Sign Up
              </Link>
            </>
          )}
