...
export default function Logo({ className = '', size = 'md' }) {
  ...
  return (
    ...
    >
      ...
      />
      <span
        className={`font-logo ${sizeClass.text} uppercase leading-none tracking-[0.06em] text-white transition-[filter] duration-300 group-hover/logo:drop-shadow-[0_0_7px_rgba(255,255,255,0.3)] sm:tracking-[0.08em]`}
      >
        SPEED TOYZ CARS
      </span>
    </span>
